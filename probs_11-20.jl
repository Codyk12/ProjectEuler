...
function prob13()
    """
    Calculates the the sum of the numbers in s.
    """
...
function prob17(m, n)
    """
    Finds the sum of the letters of number m to n
    """
    single = Dict(
    '1' => 3,
    '2' => 3,
    ...
    for i = m : n
        ...
        elseif (n == 3)
            ...
            if (s[2:3] != "00")
                ...
                elseif (s[2] == '1')
                    sum += double[s[2:3]]
                else # second digit is not 0 or 1
                    sum += double[s[2]*"0"]
...
function prob18()
    """
    Finds largest sum path through the triangle
    """
    s = [[75],
    [95, 64],
    [17, 47, 82],
